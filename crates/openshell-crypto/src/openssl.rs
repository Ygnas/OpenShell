...
//! System-OpenSSL implementation of the backend contract.
//!
//! Selecting this module does not attest FIPS mode. The linked OpenSSL module,
//! provider configuration, host policy, and deployment must be qualified
//! separately.
